...
if __name__ == "__main__":
    ...
    output_dir = "fluid/results_cylinder_channel_getfem_quad_fenics_new_mesh"
...
########## to do #########
# - try to updated the quad mesh  and run a simulation with that or higher order elements??
# - 