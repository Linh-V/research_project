// Mesh for TF FSI2 benchmark test- > FLUID DOMAIN
h_ref = 0.5;
...
// Beam end points
Point(12) = {l_beam_from0, c + h/2, 0, h_ref/20}; // Top right of beam
Point(13) = {l_beam_from0, c - h/2, 0, h_ref/20}; // Bottom right of beam
...
Recombine Surface {1, 5, 16, 2, 7, 6, 12, 17, 8, 13, 3, 9,14, 18, 4, 10, 11, 15, 19};
N_mult = 1.2;
N1 = 4*N_mult;
N2= 4*N_mult;
N3 = 6*N_mult;
...
//+
Transfinite Curve {40, 43} = N4 Using Progression pf_bd;
//+
...
//+
Transfinite Curve {40, 41} = N4 Using Progression pf_bd;
//+
...
//+
Transfinite Curve {42, 41} = N4 Using Progression 1/pf_bd;
//+
...
//+
Transfinite Curve {42, 23} = N4 Using Progression pf_bd;
//+
...
//+
Transfinite Curve {27, 43} = N4 Using Progression pf_bd;
//+
...
//+
//Transfinite Curve {28, 25} = N5 Using Progression 1;
//+
...
//+
Physical Curve("CYLINDER", 57) = {17, 18, 19, 20, 21};
//+
Physical Curve("BEAM_LEFT", 58) = {22};
//+
